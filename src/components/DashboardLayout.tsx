    ...
    <div className="min-h-[calc(100vh-100px)] bg-[var(--layout-page-background)]">
      <div className="mx-auto flex max-w-[1440px] flex-col gap-5 px-4 py-5 lg:flex-row lg:items-start">
        <aside className="w-full shrink-0 lg:w-[286px]">
          <div className="sticky top-24 overflow-hidden rounded-sm border border-black/20 bg-[var(--layout-dashboard-sidebar-bg)] shadow-sm">
            <div className="border-b border-white/10 bg-[var(--layout-dashboard-sidebar-header-bg)] px-5 py-5 text-[var(--layout-dashboard-sidebar-text)]">
              <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-[var(--layout-accent-color)]">Cookie market</p>
                  ...
                  <Link
                    ...
                    className={`flex shrink-0 items-center gap-3 rounded-sm px-3 py-2.5 text-sm transition-colors lg:w-full ${
                      isActive 
                        ...
                        : 'text-[var(--layout-dashboard-sidebar-text)]/80 hover:bg-white/10 hover:text-[var(--layout-dashboard-sidebar-text)]'
                    }`}
                  >
