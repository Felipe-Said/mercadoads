...
export function Personalizacao() {
  ...
  const [banners, setBanners] = useState([
    { id: 1, image: "https://http2.mlstatic.com/D_NQ_858591-MLA76953259972_062024-OO.webp", link: "/ofertas" },
    { id: 2, image: "https://http2.mlstatic.com/D_NQ_709295-MLA76868512521_062024-OO.webp", link: "/groups" }
  ])
                ...
                <div key={banner.id} className="p-4 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-grow">
                    ...
                    <input 
                      type="text" 
                      value={banner.image}
                      className="w-full h-8 px-2 border border-gray-200 rounded-sm focus:outline-none focus:border-ml-blue text-sm mb-2 text-gray-600"
                      readOnly
                    />
